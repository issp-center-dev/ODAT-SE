...
if __name__ == "__main__":
    ...
    parser.add_argument("--xcol", type=int, default=1, help="Column index for x coordinates in input files (default: 0)")
    parser.add_argument("--ycol", type=int, default=2, help="Column index for y coordinates in input files (default: 1)")
