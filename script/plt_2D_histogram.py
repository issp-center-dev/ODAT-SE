...
def main():
    ...
    for file_path in file_list:
        try:
            ...
            # Extract beta value in scientific notation
            ...
            # Generate 2D histograms for all pairs of z_columns
            for ix, iy in pairs:
                id_x = field_id[ix]
                id_y = field_id[iy]
                ...
                if auto_axis:
                    ...
                    xrange = hist_range[id_x - 2] #XXX index
                    yrange = hist_range[id_y - 2] #XXX index
                ...
                # Plotting with 'Reds' colormap and log scale
                fig, ax = plt.subplots(figsize=(8, 6))
                X, Y = np.meshgrid(xedges, yedges)
                cmap = ax.pcolormesh(X, Y, H.T, cmap='Reds', shading='auto', norm=LogNorm(vmin=1e-3, vmax=1))  # LogNorm applied
                ...
                # Save the plot with corrected filename format
