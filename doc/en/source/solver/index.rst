...
Currently, the only solver built into ODAT-SE is ``analytical``.
Direct problem solvers for two-dimensional material structure analysis are provided as wrapper packages (see :doc:`/start`).
...
- ``function_name``
  ...
  - ``himmelblau``
    ...
    - `Himmelblau function <https://en.wikipedia.org/wiki/Himmelblau%27s_function>`_
