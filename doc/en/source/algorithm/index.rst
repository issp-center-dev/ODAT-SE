...
:doc:`global_search`
    Performs global optimization using the routines of scipy.optimize. Differential evolution and shgo are available, with MPI-parallel evaluation of the candidate points. Requires scipy.
